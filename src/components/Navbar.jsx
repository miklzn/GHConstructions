const Navbar = () => {
  return (
    <section className="h-auto w-full absolute">
      <nav class="w-full relative z-10 bg-emerald-900 px-[3vw] py-[1.4vw] border-b-4 border-emerald-900 sm:px-[3vw] sm:py-[4.4vw] md:px-[2.4vw] md:py-[1vw] lg:px-[3.5vw] xl:px-[10vw]">
